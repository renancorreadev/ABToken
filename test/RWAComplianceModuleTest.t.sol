...
contract RWAComplianceModuleTest is Test {
    RWAComplianceModule complianceRWAComplianceModule;
    MockModularCompliance complianceMock;
    address owner;
    address buyer;
    address buyer2;
    address nonApprovedBuyer;
    address approvedBuyer;

    uint256 buyer2PrivateKey;
    uint256 ownerPrivateKey;
    uint256 buyerPrivateKey;
    uint256 nonApprovedBuyerPrivateKey;
    uint256 approvedBuyerPrivateKey;

    uint256 private minIncomeRequired = 5000 ether;
